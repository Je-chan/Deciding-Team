...
function disapper() {
  return new Promise((resolve, reject) => {
    developers.style.transition = `opacity ${0.5}s ease-out`
    developers.style.opacity = 0
    buttonBack.style.transition = `opacity ${0.5}s ease-out`
...
function transformation(selectWrapper) {
  return new Promise((resolve, reject) => {
    ...
    selectWrapper.style.transition = `all ${1}s ease-out`
  })
}
